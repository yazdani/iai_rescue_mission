...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        str1.type = "how"
        str1.command = "Go across the river right of this mountain"
        str1.data = 1.0
        ...
        str1.type = "how"
        str1.command = "Go over the river and take a picture of that tree"
        str1.data = 1.0
        str1.direction = [2.0, 0.0, 0.0]
        str1.location = [3.0, 0.0, 0.0]
        str1.confidence = 1.98
        ...
        str1.selected = "red hawk"
        str1.type = "how"
        str1.command = "Go behind of this river next to the wood"
        str1.data = 1.0
        str1.direction = [2.0, 0.0, 0.0]
        str1.location = [3.0, 0.0, 0.0]
        str1.confidence = 1.98
        ...
        str1.selected = "red hawk"
        str1.type = "how"
        str1.command = "Go over the river next to that tree and take a picture"
        str1.data = 1.0
        str1.direction = [2.0, 0.0, 0.0]
        str1.location = [3.0, 0.0, 0.0]
        str1.confidence = 1.98
        ...
        str1.selected = "red hawk"
        str1.type = "how"
        str1.command = "Go straight until you reach the wood"
        str1.data = 1.0
        str1.direction = [2.0, 0.0, 0.0]
        str1.location = [3.0, 0.0, 0.0]
        str1.confidence = 1.98
