...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        str1.type = "how"
        str1.command = "Go right of that tree and take a picture"
        str1.data = 1.0
        str1.direction = [2.0, 0.0, 0.0]
        str1.location = [3.0, 0.0, 0.0]
        str1.confidence = 1.98
        ...
        str1.selected = "red hawk"
        str1.type = "how"
        str1.command = "Go behind of the river next to that tree"
        str1.data = 1.0
        str1.direction = [2.0, 0.0, 0.0]
        str1.location = [3.0, 0.0, 0.0]
        str1.confidence = 1.98
        ...
        str1.selected = "red hawk"
        str1.type = "how"
        str1.command = "Go behind the river next to that tree"
        str1.data = 1.0
        str1.direction = [2.0, 0.0, 0.0]
        str1.location = [3.0, 0.0, 0.0]
        str1.confidence = 1.98
        ...
        str1.selected = "red hawk"
        str1.type = "how"
        str1.command = "Go behind the river next to that tree and scan the area"
        str1.data = 1.0
        str1.direction = [2.0, 0.0, 0.0]
        str1.location = [3.0, 0.0, 0.0]
        str1.confidence = 1.98
